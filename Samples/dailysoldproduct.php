...
$id = $_SESSION['id'];
	...
	$query = "SELECT SUM(od.order_qty) as total, m.m_name as name, o.order_time as tim FROM menus as m, order_details as od, orders as o WHERE m.menu_id = od.menu_id AND od.order_id = o.order_id AND o.restaurant_id = '$id' GROUP BY DATE_FORMAT(o.order_time, '%D') LIMIT 5";
