                            ...
                            <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                    ...
                                    <ul class="nav navbar-nav navbar-left">
                                        ...
                                        <li><a href="View/restaurant.php">Restaurants</a></li>
                                        <!--<li><a href="#features">Tables</a></li>-->
                                        <li><a href="View/mostordered.php">Most Ordered</a></li>
                                        <li><a href="View/events.php">News & Events</a></li>
                                        <li><a href="View/blog.php">Blogs</a></li>
                                        <li><a href="View/login.php" class="booking">Book a Table</a></li>
                                    </ul>
                                      <ul class="nav navbar-nav navbar-right">
                                            <li><a href="View/login.php" class="booking">Sign Up & Login</a></li>
                                     </ul> 
                                </div><!-- /.navbar-collapse -->
                            </div><!-- /.container-fluid -->
                        </nav>
