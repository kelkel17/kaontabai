...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<br>
		<center>
		<form action="../../Controller/BeveragesController/addbeverage.php" method="POST" enctype="multipart/form-data">
                     <table>
						 <tr>
							<td colspan="2"><h1>Add Beverage</h1><hr/></td>
						 </tr>
                        ...
                        <tr>
                            ...
                            <td><label>Beverage Price</label>
                            	<input  class="form-control" type="number" name="price" required></td>      
							...
							<!-- <td align="left">Beverage Image:&nbsp;&nbsp;</td> -->
						    ...
						    <td><label>Beverage Description</label>
                            	<textarea class="form-control" maxlength="50" type="text" name="desc" required></textarea></td>
