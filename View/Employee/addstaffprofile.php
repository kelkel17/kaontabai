<?php 
	...
	$data = array($id,$fname,$mname,$lname,$addr,$phone,$gender,$ssn,$stat,$rate);
	addStaff($data);
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<form method="POST">
                     <table>
						 <tr>
							<td colspan="2"><h1>Add Staff</h1><hr/></td>
						 </tr>
						
                        <tr>
                             <!-- <td align="left">First name:&nbsp;&nbsp;</td> -->
                            <td><label>First Name</label>
                            	<input class="form-control" type="text" name="fname" required></td>
                            
                    
                            <!-- <td align="left">Middle Name:&nbsp;</td> -->
                            <td><label>Middle Name</label>
                            	<input class="form-control" type="text" name="mname"></td>
                      
                            	
                            <!-- <td align="left">Lastname:&nbsp;&nbsp;</td> -->
                            <td><label>Last Name</label>
                            	<input class="form-control" type="text" name="lname" required></td>      
                     
							<!-- <td align = "left">Address:&nbsp;&nbsp;</td> -->
							<td><label>Address</label>
                            	<input class="form-control" type="text" name="addr" required></td>
						 
							<!-- <td align="left">Phone:&nbsp;&nbsp;</td> -->
							<td><label>Phone</label>
                            	<input class="form-control" type="text" name="phone" required></td>
							...
							<td><label>SSN</label>
                            	<input class="form-control" type="text" name="ssn"></td>
						 </tr>
