                                ...
                                <div class="panel-body">
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Username" name="username" type="username" value="<?php echo $row['username'];?>" required>
                                            <br/>
                                            <input class="form-control" placeholder="Password" name="password" type="password" value="<?php echo $row['password'];?>" required>
                                            <br/>
                                            <input class="form-control" placeholder="Restaurant Name" name="rname" type="text" value="<?php echo $row['restaurant_name'];?>" required>
                                            <br/>
                                            <input class="form-control" placeholder="Restaurant Address" name="addr" type="text" value="<?php echo $row['restaurant_addr'];?>" required>
                                            <br/>
                                            <input class="form-control" placeholder="Restaurant Contact" name="contact" type="text" value="<?php echo $row['restaurant_contact'];?>" required>
                                            <br/>
                                            ...
                                            <?php 
                                                ...
                                                <div id="some-div">
                                                    ...
                                                    <?php echo $rows['promo_name'];?>

                                                        <input type="checkbox" name="promo[]" value="<?php echo $rows['promo_id'];?>">
                                                        <br/>
