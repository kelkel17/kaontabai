...
$myID = $_GET['id'];
  ...
  if(isset($_POST['submit'])){
    ...
    updatedessert($myID,$name,$desc,$price,$qty,$imagebase64);
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="../../Model/Dessert/dessert.php"><em class="fa fa-clone">&nbsp;</em>Desserts</a></li>
    ...
    foreach ($res as $row){
     ...
     ?>
		...
		<form method="POST" enctype="multipart/form-data">
                     <table>
						 <tr>
							<td colspan="2"><h1>Update Desserts</h1><hr/></td>
						 </tr>
						
                        <tr>
                             <!-- <td align="left">Dessert Name:&nbsp;&nbsp;</td> -->
                            <td><label>Dessert Name</label>
                            	<input class="form-control" type="text" name="name" value="<?php echo $row['des_name']; ?>" required></td>
                            

                             <!-- <td align="left">Dessert Descreption:&nbsp;&nbsp;</td> -->
    
                            
                            <td align="left">Dessert Price:&nbsp;&nbsp;</td>
                            <td><input type="text" name="price" value="<?php echo $row['des_price']; ?>" required></td>      

                            <td align="left">Dessert Status:&nbsp;</td>
                             <td><select name="qty" value="<?php echo $row['des_qty']; ?>" required>
                            	<option value="Available">Available</option>
                            	<option value="Not Available">Not Available</option>
                            </select></td>

							<td align="left">Food Image:&nbsp;&nbsp;</td>
							<td><input type="file" name="image" accept = "image/jpeg" value="<?php echo $row['des_image']; ?>" /></td>
						 	                        <td><label>Dessert Description</label>
                            	<textarea class="form-control" type="text" name="desc" value="" required><?php echo $row['des_desc']; ?></textarea></td>
            ...
            <br><br>
            <input type="submit" name="submit" value="Save Profile" class="btn btn-primary btn-lg" type="button">
        </form>      
        </center> 
                    <br>
                    <br>
