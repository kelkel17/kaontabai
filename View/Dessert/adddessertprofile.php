...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<br>
		<center>
		<form action="../../Controller/DessertsController/adddessert.php" method="POST" enctype="multipart/form-data">
                     <table>
						 <tr>
							<td colspan="2"><h1>Add Desserts</h1><hr/></td>
						 </tr>
						
                        <tr>
                             <!-- <td align="left">Dessert Name:&nbsp;&nbsp;</td> -->
                            <td> <label>Desser Name</label>
							...
							<td><label>Food Image</label>
                            	...
                            	<textarea class="form-control" rows="4" cols="50" name="desc" required></textarea></td>
