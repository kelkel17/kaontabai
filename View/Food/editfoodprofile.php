...
islogged();
  ...
  if(isset($_POST['submit'])){
    ...
    updatefood($myID,$name,$desc,$category,$price,$qty,$imagebase64);
    echo '<script> alert("Successfully Updated the Food"); window.location="../../Model/Food/food.php" </script>';
                     ...
                     <table>
                        ...
                        <tr>
                            ...
                            <td><label>Food Name</label>
                            	<input class="form-control" type="text" name="name" value="<?php echo $row['food_name']; ?>" required></td>

                             <!-- <td align="left">Food Descreption:&nbsp;&nbsp;</td> -->
                            <td><label>Food Description</label>
                            	<textarea class="form-control" type="text" name="desc" value="" required><?php echo $row['food_desc']; ?></textarea></td>
             
                            <!-- <td align="left">Food Category:&nbsp;</td> -->
                             <td><label>Food Category</label><select class="form-control" name="category" value="<?php echo $row['food_category']; ?>" required>
                            ...
                            <td><label>Food Price</label>
                            	<input class="form-control" type="text" name="price" value="<?php echo $row['food_price']; ?>" required></td>      

                            <!-- <td align="left">Food Status:&nbsp;</td> -->
                             <td><label>Food Status</label>
                            	<select class="form-control" name="qty" value="<?php echo $row['food_qty']; ?>" required>
							...
							<td><label>Food Image</label>
                            	<input class="form-control" type="file" name="image" accept = "image/jpeg" value="<?php echo $row['food_image']; ?>" /></td>
						 </tr>
                          <?php }}?>
            </table>
            <br><br>
