		...
		<form method="POST" enctype="multipart/form-data">
                     <table>
                        ...
                        <tr>
                            ...
                            <td><label>Date</label>
                            	<input class="form-control" type="date" name="date" required></td>
                            
                             <!-- <td align="left">Food Name:&nbsp;&nbsp;</td> -->
                            <td><label>Time</label>
                            	<input class="form-control" type="time" name="time" required></td>
                            </tr>
                 
                          
            </table>
            <br><br>
            <input type="submit" name="Add" value="Save" class="btn btn-primary btn-lg" type="button">
        </form>      
        </center> 
<br>
