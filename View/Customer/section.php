 <section  style="margin-top: 5%;">
                       ...
                       <div class="form-group">
                            <label >Search by: </label>
                              <select name="filter" id="filter"  class="form-control" style="width: 15%;">
                                  ...
                                  <option value="0">Restaurant Name</option>
                          ...
                          <div class="abouts_content">
                              ...
                              <div class="col-md-6" id="tableFooter">
                                  <div class="single_abouts_text wow slideInRight" data-wow-duration="1s">
                                      ...
                                      <br>
                                      <a href="restaurantinfo.php?cid=<?php echo $row['restaurant_id']; ?>">
                                          

                                       
                                     
                                     <a href="restaurantinfo.php?cid=<?php echo $row['restaurant_id']; ?>" class="btn btn-primary">Book A Table</a>
                                      <?php
        ...
        <section id="div1" class="abouts" style="margin-top: -2%;">
