					        ...
					        <div class="modal-dialog" role="document">
					            <div class="modal-content">
					                <div class="modal-header">
				                    	...
				                    	<center><h3 class="modal-title">Update Product</h3></center>
                   					</div>
					                ...
					                <div class="modal-body">
	                                       <div class="form-group text-center">
					                           ...
					                           <div class="tab-pane">
					                                ...
					                                <textarea type="text" name="desc" id="desc" class="form-control"><?php echo $row['area_desc'];?></textarea>
					                                <span class="highlight"></span><span class="bar"></span>
					                            </div>
   ...
   <div class="modal fade" tabindex="-1" role="dialog" id="deactProduct<?php echo $row['table_id']; ?>">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <center><h3 class="modal-title">Reserve this table</h3></center>
                    </div>
                    <div class="modal-body">
          ...
          </div><!-- end of deactivate Product modal -->  
          ...
          <div class="modal fade" tabindex="-1" role="dialog" id="actProduct<?php echo $row['table_id']; ?>">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <center><h3 class="modal-title">Change status to available</h3></center>
                    </div>
                    <div class="modal-body">
          ...
          </div><!-- end of Activate Product modal --> 