...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="../Beverage/beverage.php"><em class="fa fa-clone">&nbsp;</em>Beverages</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href='../../View/beverage/addbeverageprofile.php'">Add Beverage</button> 
			<div class="col-lg-4">
