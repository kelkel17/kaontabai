    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center>
                    <h3 class="modal-title">Do you want to change the schedule status to off-peak?</h3></center>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center>
                    <h3 class="modal-title">Do you want to change the schedule status to Peak Hour?</h3></center>
            </div>
            <div class="modal-body">
                <h5 class="text-center">Are you sure you want to change the status of this schedule?</h5>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center>
                    <h3 class="modal-title">Update Schedule</h3></center>
            </div>
