...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="staff.php"><em class="fa fa-clone">&nbsp;</em> Staff</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<!-- <button type="button" class="btn btn-primary btn-lg" onclick="window.location.href='../../View/Employee/addstaffprofile.php'">Add Staff</button>  -->
			<div class="col-lg-4">
		    <div class="input-group">

		      <input type="text" id="myInput" class="form-control" onkeyup="searchTable()" placeholder="Search for...">
       ...
       // while($row = mysqli_fetch_assoc($result))
        {
	       ...
	       echo '<div class="cell">';
                    echo '<td> <a href="#?id='.$row['employee_id'].' "> <input type="submit" class="btn btn-info btn-sm" value="Update"></a><br><br><a href="#?id='.$row['employee_id'].' "> <input type="submit" class="btn btn-info btn-sm" value="Delete"></a></td></tr>';
                echo '</div>';             
        }
