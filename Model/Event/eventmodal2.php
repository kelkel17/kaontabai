    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center>
                    <h3 class="modal-title">Update Event</h3></center>
            </div>
            <form method="post" action="../../Controller/EventsController/addevent.php">
                ...
                <div class="modal-body">
                    ...
                    <div class="tab-pane">
                        ...
                        <textarea name="desc" id="pdesc" class="form-control" required>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center>
                    <h3 class="modal-title">Do you want to Open</h3></center>
            </div>
            <div class="modal-body">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center>
                    <h3 class="modal-title">Do you want to Close this event?</h3></center>
            </div>
            <div class="modal-body">
                <h5 class="text-center">Are you sure you want to change the status of this event?</h5>
            </div>
