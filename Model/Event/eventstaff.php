...
?>
    ...
    <?php include('../header.php'); ?>
        ...
        <ul class="nav menu">
            ...
            <li class="active"><a href="../Event/eventstaff.php"><em class="fa fa-bar-chart">&nbsp;</em> Events</a></li>
	    ...
	    ?>
            ...
            <script>
                $(document).ready(function() {
                    $.ajax({
                        type: "GET",
                        url: "../../Controller/EventsController/getevent.php",
                        dataType: 'json',
                        success: function(data) {
                            for (var i = 0; i < data.length; i++) {
                                //console.log(data[i]);
                                var test3 = moment().add(7, 'days');
                                var test2 = moment(test3).local().format('LL');
                                var test = moment().day("Sunday").format('LL');
                                ...
                                console.log(date2);
                                // console.log(count);
                                if (test <= date2 && test2 >= date2) {
                                    swal("You have " + count + " upcoming event this week", {
                                        icon: "info"
                                    });
                                }
                            }
