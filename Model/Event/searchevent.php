...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="../events.php"><em class="fa fa-bar-chart">&nbsp;</em> Events</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			...
			<button type="button" class="btn btn-primary btn-lg" onclick="window.location.href='../../View/Event/addevent.php'">Add Event</button> 
       ...
       // while($row = mysqli_fetch_assoc($result))
        {
	       ...
	       echo '<td>'.$row['total_part'].'</td>';
	       echo '<div class="cell">';
                    echo '<td> <a href="#?id='.$row['event_id'].' "> <input type="submit" class="btn btn-info btn-sm" value="Update"></a><br><br><a href="#?id='.$row['event_id'].' "> <input type="submit" class="btn btn-info btn-sm" value="Delete"></a></td></tr>';
                echo '</div>';             
        }
    ?>
