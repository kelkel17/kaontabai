                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <?php
                                          ...
                                          ?>
                                <h3 class="modal-title">Book a table now at <?php $row['restaurant_name'];?>'s Restaurant to order this delicious food.</h3>
                                <?php } ?>
                        </div>
                        <div class="modal-footer">
                            <button data-dismiss="modal" class="btn btn-primary hover" data-animation="false">Close</button>
                            <a href="restaurantinfo.php?cid=<?php echo $_SESSION['id']?>&id=<?php echo $Resid;?>" class="btn btn-primary">Book Now!</a>
                        </div>
                        <!-- end modal-footer -->
                    </div>
                </div>
