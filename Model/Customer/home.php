...
<section id="ourPakeg" class="ourPakeg">
      ...
      $con = con();
    $id = $_SESSION['id'];
    $sql = "SELECT * FROM orders o, customers c, restaurants r WHERE o.restaurant_id = r.restaurant_id AND o.customer_id = c.customer_id AND o.customer_id = '$id' ORDER BY o.order_id DESC LIMIT 1";
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title">Your order is ready to be serve!</h3>
                    <?php } elseif($row['status'] == 'Cooking'){?>
                    <h3 class="modal-title">Your order is now being cooked and will be serve!</h3>
                    <?php echo $row['order_id'];?>
                    <?php } elseif($row['status'] == 'Cancelled'){?>
                    <h3 class="modal-title">Your order has been cancelled please contact the restaurant for your refunds!</h3>
                    <?php } ?><br/>
                    <blockquote>
                       <cite class="pull-right">From: <?php echo $row['restaurant_name']?></cite>
                    </blockquote>
                   </div>
    ...
    <?php } ?>
        ...
        <!-- <script type="text/javascript">
            $(document).ready(function(){
                ...
                console.log(value);
                if(value == text  || value == 'Served'){
                    $('#modalShow').hide();
                } else if(value != text){
                    console.log(value);
                    $('#modalShow').modal('toggle').show();
                }
            });
        </script> -->
<script>
