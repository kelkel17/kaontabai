                                ...
                                <?php
                                  ...
                                  ?>
                                    <tr>
                                        ...
                                        <td>
                                            <center>&#8369;
                                                <?php echo number_format($rows['pr'],2);?>
                                            </center>
                                        </td>
                                        <td>
                                            <center>
                                        ...
                                        <td>
                                            <center><a href="#" data-toggle="modal" data-target="#viewOrder<?php echo $rows['order_id'] ?>"><i class="fa fa-eye" aria-hidden="true" title="View"></i></a>
                                            </center>
                                        </td>
