                ...
                <div class="row">
                    ...
                    <?php
                      ...
                      <div class="col-lg-9 table-responsive" style="margin-top: 10%; margin-left: 1%;">
                                <h2>Reservation History</h2><br><br>
                               ...
                               <table id="dataTable">
                                <thead>
                                  <tr>
                                    ...
                                    <th><center>Special Requests</center></th>
                                ...
                                <tbody>
                                 <?php
                                  ...
                                  ?>
                                  <tr>
                                      <td><center><?php echo $row['reservation_number']; ?></center></td>
                                      <td><center><?php echo $row['restaurant_name']; ?></center></td>
                                      <td><center><?php echo date('F j, Y g:i A', strtotime($row['reservation_date'])); ?></center></td>
                                      <td><center><?php echo $row['no_of_guests'];?></center></td>
                                      <td><center><?php echo $row['spec_reqs'];?></center></td>
                                      <td><center><?php echo $row['res_status'];?></center></td>
                                      <?php if($row['res_status'] == 'Reserved' || $row['res_status'] == 'Cancelled'){?>
                                      <td><center><i class="fa fa2 fa-pencil-square-o" title="Edit"></i>
                                      <i class="fa fa2 fa-times" title="Cancel reservation"></i></center></td>
                                      <?php } else{?>
                                      <td><center><a href="#" data-toggle="modal" data-target="#editReservation<?php echo $row['reservation_id'];?>"><i class="fa fa-pencil-square-o" title="Edit"></i></a>
                                      <a href="#" data-toggle="modal" data-target="#cancelReservation<?php echo $row['reservation_id'];?>"><i class="fa fa-times" title="Cancel reservation"></i></a></center></td>
                                      <?php } ?>
